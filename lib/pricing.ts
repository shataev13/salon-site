...
export const PRICE_CATEGORIES: PriceCategory[] = [
  ...
  },
  {
    ...
    title: "Массаж",
    intro:
      "Расслабляющий и спортивный массаж, программы для лица и тела — снятие напряжения и тонус.",
    placeholder: "u-ph-3",
    groups: [],
    note: "Актуальную стоимость и программы массажа уточняйте у администратора.",
  },
  {
    id: "spa",
