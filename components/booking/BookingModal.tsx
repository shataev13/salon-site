  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-end justify-center sm:items-center sm:p-6">
      ...
      <div
        ...
        tabIndex={-1}
        className={`u-panel-in relative z-[1] max-h-[92vh] w-full overflow-y-auto rounded-t-3xl bg-background p-6 shadow-2xl outline-none sm:rounded-3xl sm:p-8 ${
          BOOKING_URL ? "max-w-3xl" : "max-w-lg"
        }`}
      >
          ...
          <div className="mt-6 grid min-h-64 place-items-center rounded-2xl border border-dashed border-brand-200 bg-surface px-6 py-10 text-center">
            <div className="max-w-xs">
              ...
              <p className="mt-1 text-sm text-ink/60">
                Онлайн-запись YClients подключается на этот экран.
              </p>
            </div>
          </div>
        )}
